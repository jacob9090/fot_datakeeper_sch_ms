...
// Count records from users
$sql_users = "SELECT COUNT(*) as total_records FROM user_table";
$result_users = $conn->query($sql_users);
$row_users = $result_users->fetch_assoc();
$total_users = $row_users['total_records'];


// Count records from user_table where role is 'Admin'
$sql_admin_role = "SELECT COUNT(*) as total_records FROM user_table WHERE role = 'Admin'";
$result_admin_role = $conn->query($sql_admin_role);
$row_admin_role = $result_admin_role->fetch_assoc();
$total_admin_role = $row_admin_role['total_records'];

// Calculate the total for all tables where role is 'Admin'
$total_admin = $total_admin_role;


// Count records from user_table where role is 'Teacher'
$sql_teacher_role = "SELECT COUNT(*) as total_records FROM user_table WHERE role = 'Teacher'";
$result_teacher_role = $conn->query($sql_teacher_role);
$row_teacher_role = $result_teacher_role->fetch_assoc();
$total_teacher_role = $row_teacher_role['total_records'];

// Calculate the total for all tables where role is 'Teacher'
$total_teachers = $total_teacher_role;


// Count records from user_table where role is 'Student'
$sql_student_role = "SELECT COUNT(*) as total_records FROM user_table WHERE role = 'Student'";
$result_student_role = $conn->query($sql_student_role);
$row_student_role = $result_student_role->fetch_assoc();
$total_student_role = $row_student_role['total_records'];

// Calculate the total for all tables where role is 'Student'
$total_student = $total_student_role;
...
<html lang="en"><head>
  ...
  <title>Daddy - Performance Overview</title>
          ...
          <ul class="nav-main">
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="performance-overview.php">
