...
require_once '../config/db-config.php'; // Add database connection
...
try {
    ...
    if ($result->num_rows > 0) {
        ...
        $total_admin = (int)($row['total_admin'] ?? 0);
    ...
    error_log("SCHOOL OVERVIEW ERROR: " . $e->getMessage());
    $_SESSION['danger_alert'] = "Error retrieving user statistics: " . $e->getMessage();
} finally {
    // Don't close connection here if used elsewhere
}
?>
...
<html lang="en"><head>
  ...
  <title>Daddy - School Overview</title>
            ...
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="school-overview.php">
      ...
      <div class="content">
        ...
        <div class="row items-push">
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                <div class="fs-1 fw-bold"><?= htmlspecialchars($total_teachers) ?></div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                <div class="fs-1 fw-bold"><?= htmlspecialchars($total_students) ?></div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                ...
                <div class="text-muted mb-3">Assignment</div>
              </div>
              <div class="block-content block-content-full block-content-sm bg-body-light fs-sm">
                <a class="fw-medium" href="javascript:void(0)">
                  View assignment
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full">
                <div class="fs-1 fw-bold">0</div>
                <div class="text-muted mb-3">Notice</div>
              </div>
              <div class="block-content block-content-full block-content-sm bg-body-light fs-sm">
                <a class="fw-medium" href="javascript:void(0)">
                  View notice
