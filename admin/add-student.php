        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="add-student.php">
      ...
      <div class="content">
        <div class="block block-rounded">
          <div class="block-header block-header-default">
            <h3 class="block-title">Add <small>Student</small></h3>
            ...
            <div class="row items-push">
              <div class="col-md-3">
                <div class="form-floating mb-4">
                  <input type="text" class="form-control" id="example-text-input-floating" name="teacher_id" placeholder="ID12345">
                  <label class="form-label" for="example-text-input-floating">Student ID</label>
                </div>
              </div>
              <div class="col-md-3">
                <div class="form-floating mb-4">
              ...
              <div class="col-md-3">
                <div class="form-floating mb-4">
                  <input type="text" class="form-control" id="example-text-input-floating" name="other_names" placeholder="John Doe" required>
              ...
              <div class="col-md-12">
                ...
                <i class="fa fa-fw fa-plus me-1"></i> Add Student
              </button>
              </div>
