...
// Get Admin Info
$stmt = $conn->prepare("SELECT first_name, last_name FROM accounts WHERE user_id = ?");
              ...
              <tbody>
                <tr>
                  <td class="text-center w-25 d-none d-md-table-cell">
                    <a class="item item-circle bg-warning text-white fs-2 mx-auto">
                  ...
                  <td>
                    <div class="py-4">
                      <div class="fs-sm fw-bold text-uppercase mb-2">
                        <span class="text-muted me-3"><i class="fa fa-calendar"></i> <?php $currentDate = date('Y-m-d'); echo $currentDate;?></span>
                        <span class="text-primary">
                          <i class="fa fa-clock"></i> <?php $currentTime = date('H:i:s'); echo $currentTime;?>
                        </span>
                      </div>
                      <p>Search for Student records and record amount_to_paid payed to initiate student registration process per % requirement</p>
                    </div>
                  </td>
                </tr>
              </tbody>
