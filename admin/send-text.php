...
<head>
  ...
  <title>Daddy - Send Text Message</title>
        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="send-text.php">
        ...
        <div class="row">
              ...
              <form action="send-text.php" method="POST" enctype="multipart/form-data">
                <div class="block block-rounded">
                  <div class="block-header block-header-default">
                    <h3 class="block-title">Sent <small>Text</small></h3>
                  ...
                  <div class="block-content">
                    ...
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-hero btn-primary me-1 mb-3 btn-block w-100">
                        <i class="fa fa-fw fa-plus me-1"></i> Send Message
                      </button>
                    </div>
            ...
            <div class="col-md-8">
              <form action="send-text.php" method="POST" enctype="multipart/form-data">
                <div class="block block-rounded">
                  <div class="block-header block-header-default">
                    <h3 class="block-title">Text <small>Status</small></h3>
                  </div>
                  <div class="block-content">
                    <div class="col-lg-12 col-xl-12">
                      mmm
