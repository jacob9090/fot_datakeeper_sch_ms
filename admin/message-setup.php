...
<head>
  ...
  <title>Daddy - Message Setup</title>
          ...
          <ul class="nav-main">
            ...
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="message-setup.php">
        ...
        <div class="row">
              ...
              <form action="send-text.php" method="POST" enctype="multipart/form-data">
                <div class="block block-rounded">
                  <div class="block-header block-header-default">
                    <h3 class="block-title">Message <small>Setup</small></h3>
                  ...
                  <div class="block-content">
                    ...
                    <div class="form-floating mb-4">
                      <input type="text" class="form-control" id="example-text-input-floating" name="sms_type" placeholder="SMS Type" required>
                      <label class="form-label" for="example-text-input-floating">SMS Type</label>
                    </div>

                    <div class="form-floating mb-4">
                      <select class="form-select" id="example-select-floating" name="sms_group" aria-label="Floating label select example">
                    ...
                    <div class="mb-4">
                      <div class="space-y-2">
                        <div class="form-check form-switch">
                          ...
                          <label class="form-check-label" for="example-switch-default1">Status</label>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="col-md-12">
                      <button type="submit" class="btn btn-hero btn-primary me-1 mb-3 btn-block w-100">
                        <i class="fa fa-fw fa-plus me-1"></i> Add Message
                      </button>
                    </div>
            ...
            <div class="col-md-8">
              <form action="send-text.php" method="POST" enctype="multipart/form-data">
                <div class="block block-rounded">
                  <div class="block-header block-header-default">
                    <h3 class="block-title">Message <small>List</small></h3>
                  </div>
                  <div class="block-content">
                    <div class="col-lg-12 col-xl-12">
                      mmm
