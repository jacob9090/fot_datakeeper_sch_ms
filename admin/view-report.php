        ...
        <div class="content-side">
          <ul class="nav-main">
            ...
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="view-report.php">
      ...
      <div class="content">
        <div class="block block-rounded text-center">
          <div class="block-content">
            <p>Content always takes up all the available width of the main container. A maximum width is set for extra
              large screen widths.</p>
          </div>
        </div>
      </div>
