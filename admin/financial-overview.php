...
<html lang="en"><head>
  ...
  <title>Daddy - Financials Overview</title>
          ...
          <ul class="nav-main">
            <li class="nav-main-item open">
              ...
              <ul class="nav-main-submenu">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link active" href="financial-overview.php">
              ...
              <ul class="nav-main-submenu">
                <li class="nav-main-item">
                  <a class="nav-main-link" href="add-subject.php">
                    <span class="nav-main-link-name">Add Subjects</span>
                  </a>
                </li>
                <li class="nav-main-item">
                  <a class="nav-main-link" href="manage-subject.php">
                    <span class="nav-main-link-name">Manage Subjects</span>
                  </a>
                </li>
              </ul>
            </li>
            ...
            <li class="nav-main-item">
              ...
              <ul class="nav-main-submenu">
                ...
                <li class="nav-main-item">
                  <a class="nav-main-link" href="manage-school-setuo.php">
          ...
          <div>
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb breadcrumb-alt push">
                ...
                <li class="breadcrumb-item active" aria-current="page">Financials overview</li>
              </ol>
            </nav>
          </div>
      ...
      <div class="content">
        ...
        <div class="row items-push">
            ...
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                ...
                <div class="d-inline-block px-3 py-1 rounded-pill fs-sm fw-semibold text-success bg-success-light">
                  <i class="fa fa-percent me-1"></i> 0
                </div>
              </div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                ...
                <div class="text-muted mb-3">Paid Students</div>
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full flex-grow-1">
                <div class="fs-1 fw-bold">43267</div>
                <div class="text-muted mb-3">Total Fees</div>
                <div class="d-inline-block px-3 py-1 rounded-pill fs-sm fw-semibold text-success bg-success-light">
          ...
          <div class="col-sm-6 col-xl-3">
            <div class="block block-rounded text-center d-flex flex-column h-100 mb-0">
              <div class="block-content block-content-full">
                <div class="fs-1 fw-bold">32245</div>
                <div class="text-muted mb-3">Fees Paid</div>
                <div class="d-inline-block px-3 py-1 rounded-pill fs-sm fw-semibold text-danger bg-danger-light">
                  <i class="fa fa-caret-down me-1"></i> 0.3%
                </div>
              </div>
              <div class="block-content block-content-full block-content-sm bg-body-light fs-sm">
                <a class="fw-medium" href="javascript:void(0)">
        ...
        <div class="block block-rounded">
          ...
          <div class="block-content block-content-full">
            <div class="row">
              <div class="col-md-12 col-xl-12 d-md-flex align-items-md-center">
