...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($stmt->num_rows > 0) {
        ...
        $updateStmt = $conn->prepare("UPDATE user_table SET reset_token = ?, token_expiry = ? WHERE email = ?");
        $updateStmt->bind_param("sss", $token, $expiry, $email);
        $updateStmt->execute();

        // Send the reset email using PHP's mail() function
        $resetLink = "https://fruitoftek.com/fedco/reset-password.php?token=" . urlencode($token);
        $subject = "Password Reset Request";
        $message = "Click the link to reset your password: " . $resetLink;
        $headers = [
            'From' => 'passwordreset@fruitoftek.com',
            'Reply-To' => 'passwordreset@fruitoftek.com',
...
<html lang="en">
  <head>
    ...
    <title>Daddy - Forgot Password</title>
              ...
              <div class="row g-0">
                <div class="col-md-6 order-md-1 bg-body-extra-light">
                  <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                    <!-- Header -->
                    <div class="p-2">
						<h5 class="mb-2 text-left text-primary">Hello! Forgot your password</h5>
						<a style="font-size: 14px;">Send a reset link</a>
					</div><br>
                    ...
                    <form class="js-validation-reminder" action="forgot-password.php" method="POST">
                      <div class="mb-4">
                        <input type="text" class="form-control form-control-alt" id="reminder-credential" name="reminder-credential" placeholder="Email">
                      </div>
					  ...
					  <div class="p-2 text-center text-muted" style="font-size: 14px;">
						  Back to <a class="text-black" href="index.php"><span class="underline"> Login</span></a>
					  </div>
                    </form>
